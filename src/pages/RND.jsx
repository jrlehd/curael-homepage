  ...
  const sections = [
    {
      ...
      desc:
        "큐라엘은 천연물 기반 항암 소재 탐색에 집중하고 있으며, 특히 암 줄기세포(CSC)와 암세포의 증식을 돕는 암 미세환경(ECM)을 타깃으로 하는 성분의 분리 및 조합을 연구합니다. 자연 기반 신약 후보물질의 작용 기전 확인과 병원 기반의 임상 협력을 통해 신약화 가능성을 모색합니다.",
      tags: ["항암소재", "CSC 억제", "ECM 연구", "기전 분석", "전임상"]
    },
    {
      title: "건강기능식품 연구",
